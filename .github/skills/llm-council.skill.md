...
### 6. The BS Detector
A cynical, battle-hardened veteran who sees organizational rot from a mile away. They look for "bait-and-switch" tactics, "multiple hats" as a mask for understaffing, and "fast-paced" as a mask for chaos. They assume the opportunity is a "shitshow" until proven otherwise.
**Why these six:** They create three natural tensions. Contrarian vs Expansionist (downside vs upside). First Principles vs Executor (rethink everything vs just do it). The Outsider and BS Detector keep everyone honest by providing fresh eyes and extreme skepticism.
---
...
**B. Frame the question.** Take the user's raw question AND the enriched context and reframe it as a clear, neutral prompt that all six advisors will receive. The framed question should include:
...
Spawn all 6 advisors simultaneously as sub-agents. Each gets:
...
This is the step that makes the council more than just "ask 6 times." It's the core of Karpathy's insight.
Collect all 6 advisor responses. Anonymize them as Response A through F (randomize which advisor maps to which letter so there's no positional bias).
